...
export const STopTextContainer = css`
    margin-top: 8px;
    text-align: center;
    font-size: 20px;
    word-spacing: -2px;
...
export const SBottomTextContainer = css`
    margin-top: 5px;
    text-align: center;
    font-size: 20px;
    word-spacing: -2px;
